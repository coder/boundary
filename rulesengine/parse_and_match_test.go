...
func TestRoundTrip(t *testing.T) {
	tcs := []struct {
		...
		{
			name:        "comma separated wildcard paths matches first",
			rules:       []string{"path=/api/v1/*,/api/v2/*"},
		...
		{
			name:        "comma separated wildcard paths matches second",
			rules:       []string{"path=/api/v1/*,/api/v2/*"},
		...
		{
			name:        "comma separated wildcard paths rejects other paths",
			rules:       []string{"path=/api/v1/*,/api/v2/*"},
			url:         "https://example.com/api/v3/other",
			method:      "GET",
			expectParse: true,
			expectMatch: false,
		},
